...
careful rigging, they have suspended a large number of small electrical 
...
circuit which contains **`4`** junction boxes, two circuits which contain **`2`** junction boxes each, and seven 
circuits which each contain a single junction box. Multiplying together the sizes of the three largest circuits (5, 4, 
